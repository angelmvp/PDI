...
public class MyImage {
     ...
     * JPG does not support alpha (transparency is lost) while PNG supports 
     * alpha.
     */
     ...
     *   Y-axis
     * 
     * This method will store the value of each pixels of a 2D image in a 1D 
     * array.
     */
     ...
     * Then calling img1.isEqual(img2) will return TRUE if img1 and img2 are 
    ...
    public boolean isEqual(MyImage img){
        //check dimension
        if(this.width != img.getImageWidth() || 
                this.height != img.getImageHeight()){
            return false;
        }
    ...
    /**
     * This method will return the amount of alpha value between 0-255 at the 
     * pixel (x,y)
     * 
    ...
    /**
     * This method will return the hue of the pixel (x,y) as per HSI color 
     * model.
     * 
     * @param x The x coordinate of the pixel.
     * @param y The y coordinate of the pixel.
    ...
    public double HSI_getHue(int x, int y){
        ...
        double H = Math.toDegrees(
                Math.acos((r - (0.5*g) - (0.5*b)) /
                        Math.sqrt((r*r)+(g*g)+(b*b)-(r*g)-(g*b)-(b*r))));
        H = (b>g)?360-H:H;
    ...
    /**
     * This method will return the saturation of the pixel (x,y) as per HSI 
     * color model.
     * 
     * @param x The x coordinate of the pixel.
     * @param y The y coordinate of the pixel.
    ...
    /**
     * This method will return the intensity of the pixel (x,y) as per HSI 
     * color model.
     * 
     * @param x The x coordinate of the pixel.
     * @param y The y coordinate of the pixel.
    ...
    public void HSI_setHue(int x, int y, double hue){
        int rgb[] = HSI_getRGBFromHSI(
                hue, HSI_getSaturation(x,y), HSI_getIntensity(x,y));
    ...
    public void HSI_setSaturation(int x, int y, double saturation){
        int rgb[] = HSI_getRGBFromHSI(
                HSI_getHue(x,y), saturation, HSI_getIntensity(x,y));
        setPixel(x, y, getAlpha(x,y), rgb[0], rgb[1], rgb[2]);
    }
    ...
    public void HSI_setIntensity(int x, int y, double intensity){
        int rgb[] = HSI_getRGBFromHSI(
                HSI_getHue(x,y), HSI_getSaturation(x,y), intensity);
        setPixel(x, y, getAlpha(x,y), rgb[0], rgb[1], rgb[2]);
    }
    ...
    private int[] HSI_getRGBFromHSI(double H, double S, double I){
        ...
        if(H == 0){
            ...
            r = (int)Math.round(I + I*S*(
                            ...
                            Math.cos(Math.toRadians(60-H))));
            g = (int)Math.round(I + I*S*(
                            1 - Math.cos(Math.toRadians(H)) / 
                                Math.cos(Math.toRadians(60-H))));
            b = (int)Math.round(I - I*S);
        }else if(H == 120){
            r = (int)Math.round(I - I*S);
            ...
            g = (int)Math.round(I + I*S*(
                            Math.cos(
                                    Math.toRadians(H-120)) /
                                    Math.cos(Math.toRadians(180-H))));
            b = (int)Math.round(I + I*S*(
                            1 - (Math.cos(
                                    Math.toRadians(H-120)) /
                                    Math.cos(Math.toRadians(180-H)))));
            ...
            r = (int)Math.round(I + I*S*(
                            1 - Math.cos(
                                    Math.toRadians(H-240)) / 
                                    Math.cos(Math.toRadians(300-H))));
            g = (int)Math.round(I - I*S);
            b = (int)Math.round(I + I*S*(
                                Math.cos(
                                        Math.toRadians(H-240)) / 
    ...
    /**
     * This method will return the saturation of the pixel (x,y) as per HSV 
     * color model.
     * 
     * @param x The x coordinate of the pixel.
     * @param y The y coordinate of the pixel.
    ...
    /**
     * This method will return the value of the pixel (x,y) as per HSV color 
     * model.
     * 
     * @param x The x coordinate of the pixel.
     * @param y The y coordinate of the pixel.
    ...
    public void HSV_setHue(int x, int y, double hue){
        int rgb[] = HSV_getRGBFromHSV(
                hue, HSV_getSaturation(x,y), HSV_getValue(x,y));
        setPixel(x, y, getAlpha(x,y), rgb[0], rgb[1], rgb[2]);
    }
    ...
    public void HSV_setSaturation(int x, int y, double saturation){
        int rgb[] = HSV_getRGBFromHSV(
                HSV_getHue(x,y), saturation, HSV_getValue(x,y));
        setPixel(x, y, getAlpha(x,y), rgb[0], rgb[1], rgb[2]);
    }
    ...
    public void HSV_setValue(int x, int y, double value){
        int rgb[] = HSV_getRGBFromHSV(
                HSV_getHue(x,y), HSV_getSaturation(x,y), value);
        setPixel(x, y, getAlpha(x,y), rgb[0], rgb[1], rgb[2]);
    }
    ...
    /**
     * This method will return the saturation of the pixel (x,y) as per HSL 
     * color model.
     * 
     * @param x The x coordinate of the pixel.
     * @param y The y coordinate of the pixel.
    ...
    /**
     * This method will return the lightness of the pixel (x,y) as per HSL 
     * color model.
     * 
     * @param x The x coordinate of the pixel.
     * @param y The y coordinate of the pixel.
    ...
    public void HSL_setHue(int x, int y, double hue){
        int rgb[] = HSL_getRGBFromHSL(
                hue, HSL_getSaturation(x,y), HSL_getLightness(x,y));
        setPixel(x, y, getAlpha(x,y), rgb[0], rgb[1], rgb[2]);
    }
    ...
    public void HSL_setSaturation(int x, int y, double saturation){
        int rgb[] = HSL_getRGBFromHSL(
                HSL_getHue(x,y), saturation, HSL_getLightness(x,y));
        setPixel(x, y, getAlpha(x,y), rgb[0], rgb[1], rgb[2]);
    }
    ...
    public void HSL_setLightness(int x, int y, double lightness){
        int rgb[] = HSL_getRGBFromHSL(
                HSL_getHue(x,y), HSL_getSaturation(x,y), lightness);
        setPixel(x, y, getAlpha(x,y), rgb[0], rgb[1], rgb[2]);
    }
