...
public class ConversortoRGB {
    ...
    public Image HSItoRGB() {
        ...
        for (int y = 0; y < alto; y++) {
            for (int x = 0; x < ancho; x++) {
                ...
                double H = h / 255.0 * 360;  // Convertir H de [0, 255] a [0, 360]
                double S = s / 255.0;        // Saturación de [0, 255] a [0, 1]
                double I = i / 255.0;        // Intensidad de [0, 255] a [0, 1]
                ...
                int azul = (int) Math.min(255, Math.max(0, B * 255));
    ...
    for (int y = 0; y < alto; y++) {
        for (int x = 0; x < ancho; x++) {
            ...
            double H = rojo / 255.0 * 360; // Tono [0, 360]
            double S = verde / 255.0;      // Saturación [0, 1]
            double V = azul / 255.0;       // Valor [0, 1]
